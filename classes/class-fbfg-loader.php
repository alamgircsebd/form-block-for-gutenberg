	...
	final class FBFG_Loader {
		...
		public function __construct() {
			...
			if ( ! $this->is_gutenberg_active() ) {
				/* TO DO */
				add_action( 'admin_notices', array( $this, 'fbfg_fails_to_load' ) );
				return;
			}
		...
		public function define_constants() {
			...
			define( 'FBFG_SLUG', 'fbfg' );
			define( 'FBFG_URI', trailingslashit( 'https://github.com/alamgircsebd/form-block-for-gutenberg/' ) );
			...
			define( 'FBFG_ASSET_VER', get_option( '__fbfg_asset_version', FBFG_VER ) );
		}
		...
		public function loader() {
			require_once FBFG_DIR . 'classes/class-fbfg-admin-helper.php';
			require_once FBFG_DIR . 'classes/class-fbfg-helper.php';
			require_once FBFG_DIR . 'classes/class-fbfg-scripts-utils.php';
			require_once FBFG_DIR . 'classes/class-fbfg-filesystem.php';
			require_once FBFG_DIR . 'classes/class-fbfg-update.php';
		}
		...
		public function load_plugin() {
			...
			require_once FBFG_DIR . 'classes/class-fbfg-post-assets.php';
			require_once FBFG_DIR . 'classes/class-fbfg-front-assets.php';
			require_once FBFG_DIR . 'classes/class-fbfg-init-blocks.php';
			require_once FBFG_DIR . 'classes/class-fbfg-rest-api.php';

			if ( 'twentyseventeen' === get_template() ) {
				require_once FBFG_DIR . 'classes/class-fbfg-twenty-seventeen-compatibility.php';
			}
		 ...
		 *      1. Global Languages /wp-content/languages/form-block-for-gutenberg/ folder
		 *      2. Local directory /wp-content/plugins/form-block-for-gutenberg/languages/ folder
		 *
		 * @since  1.0.0
		 * @return void
		 */
		public function load_textdomain() {
			 ...
			 */
			$lang_dir = apply_filters( 'fbfg_languages_directory', FBFG_ROOT . '/languages/' );

			load_plugin_textdomain( 'form-block-for-gutenberg', false, $lang_dir );
		}
		 ...
		 * @return void
		 */
		public function fbfg_fails_to_load() {
			...
			$message = sprintf( __( 'The %1$sForm Block for Gutenberg%2$s plugin requires %1$sGutenberg%2$s plugin installed & activated.', 'form-block-for-gutenberg' ), '<strong>', '</strong>' );

			$action_url   = wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=gutenberg' ), 'install-plugin_gutenberg' );
			$button_label = __( 'Install Gutenberg', 'form-block-for-gutenberg' );
		...
		public function activation_reset() {
			update_option( '__fbfg_do_redirect', true );
		...
		public function deactivation_reset() {
			update_option( '__fbfg_do_redirect', false );
		}
	}
