...
/**
 *  Prepare if class 'FBFG_Filesystem' exist.
 *  Kicking this off by calling 'get_instance()' method
 */
FBFG_Filesystem::get_instance();
 ...
 * @since 1.0.0
 */
function fbfg_filesystem() {
	return FBFG_Filesystem::get_instance()->get_filesystem();
}
