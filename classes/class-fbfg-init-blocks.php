...
class FBFG_Init_Blocks {
	...
	/**
	 * Gutenberg block category for FBFG.
	 *
	...
	public function register_block_category( $categories, $post ) {
		return array_merge(
			...
			array(
				array(
					'slug'  => 'fbfg',
					'title' => __( 'Form Blocks Blocks', 'form-block-for-gutenberg' ),
				),
			)
		);
	}
	...
	public function editor_assets() {
		$fbfg_ajax_nonce = wp_create_nonce( 'fbfg_ajax_nonce' );
		...
		wp_set_script_translations( 'fbfg-block-editor-js', 'form-block-for-gutenberg' );

		// Styles.
		wp_enqueue_style(
			'fbfg-block-editor-css', // Handle.
		...
		// Common Editor style.
		wp_enqueue_style(
			'fbfg-block-common-editor-css', // Handle.
			FBFG_URL . 'admin/assets/common-block-editor.css', // Block editor CSS.
			array( 'wp-edit-blocks' ), // Dependency to include the CSS after it.
			FBFG_VER
		);

		wp_enqueue_script( 'fbfg-deactivate-block-js', FBFG_URL . 'admin/assets/blocks-deactivate.js', array( 'wp-blocks' ), FBFG_VER, true );
		...
		wp_localize_script(
			'fbfg-deactivate-block-js',
			'fbfg_deactivate_blocks',
			array(
		...
		wp_localize_script(
			...
			array(
				...
				'fbfg_ajax_nonce'      => $fbfg_ajax_nonce,
				'fbfg_home_url'        => home_url(),
				'user_role'            => $this->get_user_role(),
				'fbfg_url'             => FBFG_URL,
				'fbfg_mime_type'       => FBFG_Helper::get_mime_type(),
