...
function FontFamilyControl( props ) {
	...
	const fonts = [
		{ value: "", label: __( "Default",'form-block-for-gutenberg' ), weight: [ "100", "200", "300", "400", "500", "600", "700", "800", "900" ], google: false },
	...
	return (
		<div className="fbfg-typography-font-family-options">
			<label className="fbfg-typography-font-family-label">{ __( "Font Family",'form-block-for-gutenberg' ) }</label>
			<Select
				options={ fonts }
			...
			/>
			<SelectControl
				label={ __( "Font Weight",'form-block-for-gutenberg' ) }
			...
			/>
			<SelectControl
				label={ __( "Font Subset",'form-block-for-gutenberg' ) }
